        ...
        <>
          ...
          <div className="xl:flex sm:inline-block justify-between">
            ...
            <div 
                ...
                data-aos="fade-right"
            >
            <h1 className="xl:text-[90px] sm:text-[35px] font-extrabold text-blue-600 ">Talent Pool<br /> Resources International</h1>
            ...
            <div className="xl:mt-40 xl:flex justify-around xl:bg-slate-400 p-10 xl:shadow-xl xl:m-2">
                ...
                <div 
                  className="xl:w-[500px] sm:mt-[40px]"
                    data-aos="fade-up"
                >
                    <h1 className="xl:text-[30px] font-extrabold text-blue-600 text-center">Mission</h1>
                   <p className="xl:text-white text-[15px]">We are professional and believe people are innovative team. 
                   ...
                   <p className="xl:text-white text-[15px]">
            ...
            <div className="xl:flex sm:inline-block justify-around xl:mt-10 sm:m-5">
                ...
                <div 
                  className="xl:w-[300px] xl:mt-[50px] p-10 shadow-xl border-2 border-b-blue-500 border-t-white border-r-white border-l-white hover:text-white hover:bg-blue-600"
                  data-aos="fade-right"
                  >
                    <h1 className="font-extrabold text-[18px] text-blue-600">Cost Effective & Flexible:</h1>
                    <p className="text-[13px]">  We’re responsive, flexible and agile. We adapt as your needs and priorities change, with a speed, 
                        efficiency and cost-effectiveness that larger firms just can’t match
                    </p>
                </div>

                <div  
                   className="sm:mt-[60px] xl:w-[300px] p-10 shadow-xl border-2 border-b-blue-500 border-t-white border-r-white border-l-white hover:bg-blue-600 hover:text-white"
                   data-aos="fade-right"
                >
                    <h1 className="font-extrabold text-[18px] text-blue-600">Consulting Expertise:  </h1>
                ...
                <div  
                   className="sm:mt-[60px] xl:w-[300px] p-10 shadow-xl border-2 border-b-blue-500 border-t-white border-r-white border-l-white hover:text-white hover:bg-blue-600"
                   data-aos="fade-right"
                 
                 >
                    <h1 className="font-extrabold text-[18px] text-blue-600">Innovative and committed to serving you:  </h1>
                    <p className="text-[13px]">
                ...
                <div  
                    ...
                    data-aos="fade-right"
                >
                    <h1 className="font-extrabold text-[18px] text-blue-600">Results-Driven:   </h1>
                    <p className="text-[13px]">
                        Our focus is on delivering actionable objectives and prioritizing tasks that directly contribute to achieving these goals. 
